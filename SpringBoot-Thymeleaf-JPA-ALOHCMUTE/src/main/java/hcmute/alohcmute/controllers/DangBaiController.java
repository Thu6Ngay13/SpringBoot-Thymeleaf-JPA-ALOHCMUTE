...
public class DangBaiController{
	...
	@PostMapping("add")
	public String add(ModelMap model,@RequestParam("noidungchu") String noidungchu,@RequestParam("manhom") String manhom,@RequestParam("privacy") String cdo,@RequestParam("file") MultipartFile noidunghinhanh)
	{
